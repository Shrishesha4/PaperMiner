'use server';
/**
 * @fileOverview A flow to refine a specific section of a research paper based on user instructions.
 *
 * - refineSection - A function that handles refining a single paper section.
...
**Current Section Text to Refine:**
---
{{{currentText}}}
---
`,
